//
//  UIView+public extension.swift
//  Cinder
//
//  Created by LanNTH on 27/08/2022.
//
...
public extension UIView {
    ...
    func getDeviceScreenshot(_ shouldSave: Bool = true) -> UIImage? {
        ...
        guard let layer = UIViewController.window?.layer else {
            return nil
        }
...
public extension UIView {
    ...
    static func createHeaderViewForSection(with title: String) -> UIView? {
